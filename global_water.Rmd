...
Now we plot the posterior under a uniform prior for several grid approximations -- 5, 10, 20 and 100 equally spaced points respectively.  As we might expect, the more grid points, the more precise our appproximation of the posterior distribution:
