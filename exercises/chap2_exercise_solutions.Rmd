...
There are four ways that the card we are looking at can be black.  One card has two black sides and the other two have white on the other side.  Therefore in two of the four cases the other side is black, giving a probablity of $0.5$.
...
In the first case where we have no information about births, the prior probability is 0.5.  We know that the probability the test is positive for species A given species A is 0.8, and we know that the average probability the test is positive for species A is $0.8 \times 0.5 + 0.35 \times 0.5 = 0.575$.  

$$
\mathrm{Pr}(A \mid +A) = \frac{\mathrm{Pr} (+A \mid A)\mathrm{Pr} (A)}{\mathrm{Pr}(+A)}
$$

Therefore the posterior probability is $(0.8 \times 0.5)/0.575 = 0.7$.  

In the second case for species A we have a probability of a twin followed by a singleton of $0.09$.  For species B it is $0.16$.  So we have:
